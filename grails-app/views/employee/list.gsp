			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'employee.description.label', default: 'Description')}" />
				...
				<g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: employeeInstance, field: "description")}</td>
