	...
	<body>
		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<g:if test="${employeeInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="employee.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${employeeInstance}" field="description"/></span>
